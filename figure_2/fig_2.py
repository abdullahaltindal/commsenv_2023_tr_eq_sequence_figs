...
df = pd.read_csv("figure_2/sa_vals_m78.csv")
...
def plot_rp(df_, col, savename, label):
    ...
    fig.plot(data="figure_2/boundaries.txt", pen="1p,black")
    fig.plot(data='figure_2/fault1.txt', pen="5p,darkblue", label="Mw=7.8")
...
plot_rp(df.sort_values(by="PGA"), 4, "figure_2/fig2_a", label=" ")
plot_rp(df.sort_values(by="SA(0.5)"), 5, "figure_2/fig2_b", label=" ")
plot_rp(df.sort_values(by="SA(1.0)"), 6, "figure_2/fig2_c", label=" ")
